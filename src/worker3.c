...
void* result_request (void* sock_) {
    ...
    sprintf(file_name_pt2, "/worker3/%d/myapp/result/result.txt", job_id);
    strcpy(file_name, cwd);
    strcat(file_name, file_name_pt2);
    // printf("file_name: %s\n", file_name);
    // sprintf(file_name, "/home/oscreader/OS/project/worker3/%d/myapp/result/result.txt", job_id);
    n = BUFSZ;
    ...
    if (pid == 0) {
        ...
        sprintf(dir_name_pt2, "/worker3/%d", job_id);
        strcpy(dir_name, cwd);
        strcat(dir_name, dir_name_pt2);
        // printf("dir_name: %s\n", dir_name);
        // sprintf(dir_name, "/home/oscreader/OS/project/worker3/%d", job_id);
...
void* exec_request(void* sock_){
    ...
    for (i = 0; i < source_num; i++) {
        ...
        sprintf(file_dir_pt2, "/worker3/%d/", job_id);
        strcpy(file_dir, cwd);
        strcat(file_dir, file_dir_pt2);
        // printf("file_dir: %s\n", file_dir);
        // sprintf(file_dir, "/home/oscreader/OS/project/worker3/%d/", job_id);
    ...
    if (pid == 0) {
        ...
        sprintf(make_addr_pt2, "/worker3/%d/myapp", job_id);
        strcpy(make_addr, cwd);
        strcat(make_addr, make_addr_pt2);
        // printf("make_addr: %s\n", make_addr);
        // sprintf(make_addr, "/home/oscreader/OS/project/worker3/%d/myapp", job_id);
    ...
    if (pid == 0) {
        ...
        sprintf(exec_addr_pt2, "/worker3/%d/myapp/bin/test", job_id);
        strcpy(exec_addr, cwd);
        strcat(exec_addr, exec_addr_pt2);
        // printf("exec_addr: %s\n", exec_addr);
        // sprintf(exec_addr, "/home/oscreader/OS/project/worker3/%d/myapp/bin/test", job_id);

        char store_addr[256];
        char store_addr_pt2[128];
        sprintf(store_addr_pt2, "/worker3/%d/myapp/result/result.txt", job_id);
        strcpy(store_addr, cwd);
        strcat(store_addr, store_addr_pt2);
        // printf("store_addr: %s\n", store_addr);
        // sprintf(store_addr, "/home/oscreader/OS/project/worker3/%d/myapp/result/result.txt", job_id);
